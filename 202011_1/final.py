...
def train_model(train, valid, train_y):
    ...
    my_model2 = lgb.train(lgb_params, train_data, 800)
    my_model3 = lgb.train(lgb_params, train_data, 700)
...
def post_processing(result):
    id_1 = [39, 1189, 327]
    id_0 = [233, 5568]
    result.loc[result['id'].isin(id_1), 'target'] = 1
    result.loc[result['id'].isin(id_0), 'target'] = 0
...
if __name__ == '__main__':
    ...
    result.to_csv(r'./raw/result.csv', index=0)
